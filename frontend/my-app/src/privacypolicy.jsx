  ...
  <div className="container mx-auto px-4 py-4 relative flex items-center justify-between">
    ...
    <div className="hidden md:flex z-10">
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="bg-blue-600 text-white px-6 py-2 rounded-full font-medium flex items-center"
      >
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-block bg-blue-600 text-white px-8 py-4 rounded-full font-medium text-lg shadow-lg"
            >
